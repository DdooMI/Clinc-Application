...
class AddDoctorPage extends StatefulWidget {
  ...
  const AddDoctorPage(
      ...
      : super(key: key);
  @override
  State<StatefulWidget> createState() => _AddDoctorPageState();
}
...
class _AddDoctorPageState extends State<AddDoctorPage> {
  ...
  Widget build(BuildContext context) {
    addDoctorController.nameController.text = widget.doctorName!;
    addDoctorController.nationalNumberController.text =
        widget.doctorNationalId!;
    addDoctorController.emailController.text = widget.doctoremail!;
    addDoctorController.ageController.text = widget.doctorage.toString();
    addDoctorController.phoneNumberController.text = widget.doctorphoneNumber!;
    addDoctorController.addressController.text = widget.doctoraddress!;
    addDoctorController.genderController.text = widget.doctorgender!;
    addDoctorController.specialityController.text = widget.doctorSpec!;
    genderValueChoose = addDoctorController.genderController.text;
